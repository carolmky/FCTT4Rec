...
class BertDataloader(AbstractDataloader):
    ...
    def _get_train_dataset(self):
        ...
        dataset = BertTrainDataset(self.args, self.Graph,self.dataset, self.train_negative_samples, self.rng, train_ranges)
        return dataset
...
class BertTrainDataset(data_utils.Dataset):
    def __init__(self, args, Graph,dataset, negative_samples, rng, train_ranges):
        self.args = args
