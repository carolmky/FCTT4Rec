...
class TrainingParser:
    ...
    def parse_model(self):
        ...
        # MEANTIME
        parser.add_argument('--absolute_kernel_types', type=str, default='p-d',help="Absolute kernel types separated by'-'(e.g. d-c). p=Pos, d=Day, c=Con")
    ...
    def parse_experiment(self):
        ...
        parser.add_argument('--experiment_name', type=str, default='meantime',help='Name for this particular experiment inside Group folder')
