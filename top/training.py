from FCTT.models import model_factory
from FCTT.dataloaders import dataloader_factory
from FCTT.trainers import trainer_factory
...
def train(args):
    ...
    model = model_factory(args,train_loader)
